...
public class StandbyStateManagementTest {
    ...
    public void testPmStandbyStateChangeNotifier() throws Exception {
        ...
        sm.lock();
        assertEquals(pmNotifier.getPreviousStandbyStatus(),StateManagement.NULL_VALUE);
        ...
        assertEquals(pmNotifier.getPreviousStandbyStatus(),
        ...
        sleep(5000);
        assertEquals(pmNotifier.getPreviousStandbyStatus(),StateManagement.PROVIDING_SERVICE);
    ...
    public void testSanitizeDesignatedList() throws Exception {
        ...
        assertEquals(listOfDesignated.size(),4);
        ...
        assertEquals(listOfDesignated.size(),2);
    ...
    */
    ...
    public void testComputeMostRecentPrimary() throws Exception {
        ...
        assertEquals(mostRecentPrimary.getPdpId(), "pdp4");
        ...
        assertEquals(mostRecentPrimary.getPdpId(), "pdp2");
