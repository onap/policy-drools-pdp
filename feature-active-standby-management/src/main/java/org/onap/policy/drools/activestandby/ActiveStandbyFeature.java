...
public class ActiveStandbyFeature implements ActiveStandbyFeatureApi,
    ...
    public static DroolsPdpsConnector getDroolsPdpsConnector(String pu) {
        ...
        String dbtype = ActiveStandbyProperties.getProperty(ActiveStandbyProperties.DB_TYPE);
        propMap.put(PersistenceUnitProperties.TARGET_DATABASE, (dbtype == null ? "MySQL" : dbtype));
