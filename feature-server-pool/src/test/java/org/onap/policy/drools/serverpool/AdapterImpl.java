...
import org.onap.policy.drools.serverpool.DroolsSessionBackup;
...
public class AdapterImpl extends Adapter {
    ...
    public void init(int index) throws Exception {
        ...
        Backup.register(new DroolsSessionBackup(DEFAULT_BUCKET_DROOLS_TIMEOUT));
        Backup.register(new TargetLock.LockBackup());
