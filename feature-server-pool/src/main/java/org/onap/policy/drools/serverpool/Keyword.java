...
public class Keyword {
    ...
    public static String lookupKeyword(Object obj) {
        ...
        for (Map.Entry<Class<?>, Lookup> testClass : classToLookup.entrySet()) {
            if (testClass.getClass().isAssignableFrom(thisClass) 
                    && (matchingClass == null
                       || matchingClass.isAssignableFrom(testClass.getClass()))) {
                // we have a first match, or a more specific match
                matchingClass = testClass.getClass();
            }
        }
    ...
    private static synchronized Lookup buildReflectiveLookup(Class<?> clazz) {
        ...
        return lookClassByName(classNameToSequence, clazz);
    }
     ...
     */
    private static Lookup lookClassByName(Map<String, String> classNameToSequence,
        Class<?> clazz) {
        Class<?> keyClass = null;
    ...
    private static class FieldLookup extends ReflectiveLookup {
        ...
        public String getKeyword(Object obj) {
            try {
                ...
                logger.error("Keyword.FieldLookup error: field={}", field, e);
                return null;
            }
        }
    }
    ...
    private static class MethodLookup extends ReflectiveLookup {
        ...
        public String getKeyword(Object obj) {
            try {
                ...
                logger.error("Keyword.MethodLookup error: method={}", method, e);
                return null;
            }
        }
    }
