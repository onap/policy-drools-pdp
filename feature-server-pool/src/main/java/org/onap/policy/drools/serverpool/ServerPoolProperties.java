...
public class ServerPoolProperties {
    ...
    public static final String SERVER_HTTPS = "server.https";
    public static final String SERVER_SELF_SIGNED_CERTIFICATES =
        "server.selfSignedCerts";

    // 'site' information
    public static final String SITE_IP_ADDRESS = "server.site.ip";
    public static final String SITE_PORT = "server.site.port";
    ...
    public static final String HOST_LIST = "server.hostlist";

    // 'Server' timeouts
    public static final String SERVER_INITIAL_ALLOWED_GAP = "server.allowedGap";
    public static final String SERVER_ADAPTIVE_GAP_ADJUST =
        "server.adaptiveGapAdjust";
    public static final String SERVER_CONNECT_TIMEOUT = "server.connectTimeout";
    ...
    public static final String DISCOVERY_SERVERS = "discovery.servers";
    public static final String DISCOVERY_TOPIC = "discovery.topic";

    // HTTP authentication
    public static final String DISCOVERY_USERNAME = "discovery.username";
    public static final String DISCOVERY_PASSWORD = "discovery.password";

    // Cambria authentication
    public static final String DISCOVERY_API_KEY = "discovery.apiKey";
    public static final String DISCOVERY_API_SECRET = "discovery.apiSecret";

    // timeouts
    public static final String DISCOVERY_PUBLISHER_SOCKET_TIMEOUT =
        "discovery.publisherSocketTimeout";
    public static final String DISCOVERY_CONSUMER_SOCKET_TIMEOUT =
        "discovery.consumerSocketTimeout";
    public static final String DISCOVERY_FETCH_TIMEOUT =
        "discovery.fetchTimeout";

    // the default is to wait 5 seconds for a read response to a 'send'
    public static final int DEFAULT_DISCOVERY_PUBLISHER_SOCKET_TIMEOUT = 5000;

    // the default is to wait 70 seconds for a read response to a 'receive'
    // (this value must be greater than DEFAULT_DISCOVERY_FETCH_TIMEOUT)
    public static final int DEFAULT_DISCOVERY_CONSUMER_SOCKET_TIMEOUT = 70000;
    ...
    public static final int DEFAULT_DISCOVERY_FETCH_TIMEOUT = 60000;

    // maximum message fetch limit
    public static final String DISCOVERY_FETCH_LIMIT = "discovery.fetchLimit";

    // this value is passed to the UEB/DMAAP server, and controls how many
    // requests may be returned in a single fetch
    public static final int DEFAULT_DISCOVERY_FETCH_LIMIT = 100;
    ...
    // encryption
    public static final String DISCOVERY_HTTPS = "discovery.https";
    public static final String DISCOVERY_ALLOW_SELF_SIGNED_CERTIFICATES =
        "discovery.selfSignedCertificates";
    ...
    public static final String MAINLOOP_CYCLE = "mainLoop.cycle";
    ...
    public static boolean getProperty(String name, boolean defaultValue) {
        ...
        if (value != null && !(value = value.trim()).isEmpty()) {
            ...
            try {
                ...
                logger.error("Property {}=\"{}\": illegal boolean -- "
                             + "using default of {}", name, value, defaultValue);
            }
        }
        return rval;
