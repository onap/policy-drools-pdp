...
@SwaggerDefinition(
    info = @Info(
        description = "PDP-D Rest Server Pool",
        version = "v1.0",
        title = "PDP-D Rest Server Pool"
    ),
    consumes = {MediaType.APPLICATION_JSON, YamlMessageBodyHandler.APPLICATION_YAML},
    produces = {MediaType.APPLICATION_JSON, YamlMessageBodyHandler.APPLICATION_YAML},
    schemes = {SwaggerDefinition.Scheme.HTTP},
    tags = {
        @Tag(name = "rest-server-pool", description = "Drools PDP Rest Server Pool")
    }
    )
public class RestServerPool {
    ...
    @ApiOperation(
            value = "Information",
            notes = "Handle the /test REST call",
    ...
    @ApiOperation(
            value = "AdminRequest",
            notes = "Handle the /admin REST call"
            )
    ...
    @ApiOperation(
            value = "VoteData",
            notes = "Handle the /vote REST call"
            )
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
    ...
    @ApiOperation(
            value = "BucketData",
            notes = "Handle the /bucket/update REST call"
            )
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
    ...
    @ApiOperation(
            value = "TopicMessage",
            notes = "Handle the /bucket/topic REST call"
            )
    ...
    @ApiOperation(
            value = "SessionData",
            notes = "Handle the /bucket/sessionData REST call"
            )
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
    ...
    @ApiOperation(
            value = "DroolsData",
            notes = "Handle the /session/insertDrools REST call"
            )
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
    ...
    @ApiOperation(
            value = "TargetLock",
            notes = "Handle the /lock/lock REST call"
            )
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
    ...
    @ApiOperation(
            value = "TargetLock",
            notes = "Handle the /lock/free REST call"
            )
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    ...
    @ApiOperation(
            value = "TargetLock",
            notes = "Handle the /lock/locked REST call"
            )
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    ...
    @ApiOperation(
            value = "TargetLock",
            notes = "Handle the /lock/audit REST call"
            )
    @Consumes(MediaType.APPLICATION_OCTET_STREAM)
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    ...
    @ApiOperation(
            value = "Server",
            notes = "Handle the /cmd/dumpHosts REST call"
            )
    @Produces(MediaType.TEXT_PLAIN)
    ...
    @ApiOperation(
            value = "Bucket",
            notes = "Handle the /cmd/dumpBuckets REST call"
            )
    @Produces(MediaType.TEXT_PLAIN)
    ...
    @ApiOperation(
            value = "Ping",
            notes = "Handle the /cmd/ping REST call"
            )
    @Produces(MediaType.TEXT_PLAIN)
    ...
    @ApiOperation(
            value = "BucketMessage",
            notes = "Handle the /cmd/bucketMessage REST call"
            )
    @Produces(MediaType.TEXT_PLAIN)
    ...
    @ApiOperation(
            ...
            notes = "Handle the /bucket/bucketResponse REST call"
            )
    ...
    @ApiOperation(
            value = "Bucket",
            notes = "Handle the /cmd/moveBucket REST call"
            )
    @Produces(MediaType.TEXT_PLAIN)
    ...
    @ApiOperation(
            value = "BucketAdjuncts",
            notes = "Handle the /cmd/dumpBucketAdjuncts REST call"
            )
    @Produces(MediaType.TEXT_PLAIN)
    ...
    @ApiOperation(
            value = "Locks",
            notes = "Handle the /cmd/dumpLocks REST call"
            )
    @Produces(MediaType.TEXT_PLAIN)
    ...
    @ApiOperation(
            value = "LocksData",
            notes = "Handle the /lock/dumpLocksData REST call"
            )
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
