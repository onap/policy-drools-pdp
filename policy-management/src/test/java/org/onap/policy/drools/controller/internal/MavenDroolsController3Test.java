...
public class MavenDroolsController3Test {
    ...
    public static final volatile CountDownLatch running1a = new CountDownLatch(1);
    public static final volatile CountDownLatch running1b = new CountDownLatch(1);
    public static final volatile CountDownLatch running2a = new CountDownLatch(1);
    public static final volatile CountDownLatch running2b = new CountDownLatch(1);
