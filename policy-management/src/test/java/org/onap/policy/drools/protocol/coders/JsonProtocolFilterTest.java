...
public class JsonProtocolFilterTest {
    ...
    /**
     * Tests that an empty rule will return false.
     */
    @Test
    ...
    /**
     * Tests that a null rule will return false.
     */
    @Test
    ...
    public void setRuleEmptyTest() {
        assertEquals("[?($ =~ /.*/)]", new JsonProtocolFilter("").getRule());
    }
    ...
    public void setRuleNullTest() {
        assertEquals("[?($ =~ /.*/)]", new JsonProtocolFilter(null).getRule());
    }
