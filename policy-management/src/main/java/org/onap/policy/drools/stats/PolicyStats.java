...
public class PolicyStats {
     ...
     */
    protected long policyExecutedCount;

    /**
     * Number of successfully executed policy transactions.
     */
    protected long policyExecutedSuccessCount;

    /**
     * Number of failed executions of policy transactions.
     */
    protected long policyExecutedFailCount;
    ...
    public void stat(@NonNull TransMetric trans) {
        ...
        averageExecutionTime = (averageExecutionTime + trans.getElapsedTime()) / policyExecutedCount;
