...
public class AggregatedPolicyController implements PolicyController, TopicListener {
    ...
    public List<ToscaPolicyTypeIdentifier> getPolicyTypes() {
        ...
        return droolsController
                .getBaseDomainNames()
                .stream()
                .map(d -> new ToscaPolicyTypeIdentifier(d, DroolsPropertyConstants.DEFAULT_CONTROLLER_POLICY_TYPE_VERSION))
    ...
    public boolean updateDrools(DroolsConfiguration newDroolsConfiguration) {
        ...
        try {
            ...
            this.properties.setProperty(DroolsPropertyConstants.RULES_ARTIFACTID, newDroolsConfiguration.getArtifactId());
