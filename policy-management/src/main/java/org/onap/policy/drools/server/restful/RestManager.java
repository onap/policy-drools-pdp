...
public class RestManager {
    ...
    */
    ...
    public Response controllerAdd(
        ...
        try {
            controller = PolicyControllerConstants.getInstance().get(controllerName);
            if (controller != null) {
    ...
    public Response controllerFeaturesInventory() {
        return Response.status(Response.Status.OK)
                        .entity(PolicyControllerConstants.getInstance().getFeatureProviders()).build();
    }
    ...
    public Response controllerFeature(
        ...
        try {
            return Response.status(Response.Status.OK)
                            .entity(PolicyControllerConstants.getInstance().getFeatureProvider(featureName))
                            .build();
        } catch (final IllegalArgumentException iae) {
    ...
    public Response controller(@ApiParam(value = "Policy Controller Name",
        ...
        try {
            return Response.status(Response.Status.OK)
                            .entity(PolicyControllerConstants.getInstance().get(controllerName)).build();
        } catch (final IllegalArgumentException e) {
    ...
    public Response controllerProperties(@ApiParam(value = "Policy Controller Name",
            required = true) @PathParam("controller") String controllerName) {
        try {
            final PolicyController controller = PolicyControllerConstants.getInstance().get(controllerName);
    ...
    public Response controllerLock(@ApiParam(value = "Policy Controller Name",
            required = true) @PathParam("controller") String controllerName) {
        final PolicyController policyController = PolicyControllerConstants.getInstance().get(controllerName);
    ...
    public Response decode(
        ...
        try {
            policyController = PolicyControllerConstants.getInstance().get(controllerName);
        } catch (final IllegalArgumentException e) {
            logger.debug(FETCH_DECODERS_BY_TOPIC_FAILED, this,
                    controllerName, topic, e.getMessage(), e);
            return Response.status(Response.Status.NOT_FOUND)
