...
public class PolicyStatsManager {
    ...
    protected final PolicyStats groupStat = new PolicyStats();
    protected final Map<String, PolicyStats> subgroupStats = new HashMap<>();
    ...
    public synchronized void stat(@NonNull String subGroupName, @NonNull TransMetric transaction) {
        ...
        PolicyStats stats = subgroupStats.getOrDefault(subGroupName, new PolicyStats());
        stats.stat(transaction);
        subgroupStats.put(subGroupName, stats);
    }
}
