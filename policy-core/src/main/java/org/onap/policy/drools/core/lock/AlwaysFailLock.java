...
public class AlwaysFailLock extends LockImpl {
     ...
     */
    public AlwaysFailLock(String resourceId, Object ownerInfo, String ownerKey, int holdSec, LockCallback callback) {
        super(LockState.UNAVAILABLE, resourceId, ownerInfo, ownerKey, holdSec, callback);
    }
