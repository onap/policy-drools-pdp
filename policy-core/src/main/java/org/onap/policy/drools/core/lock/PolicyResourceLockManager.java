    ...
    public Lock lock(String resourceId, Object ownerInfo, int holdSec, LockCallback callback, boolean waitForLock) {
        ...
        try {
            ...
            if (feature != null) {
                ...
                return feature.lock(resourceId, ownerInfo, holdSec, callback, waitForLock);
            }
        ...
        LockImpl lock = new LockImpl(Lock.State.UNAVAILABLE, resourceId, ownerInfo, null, holdSec, callback, false);
