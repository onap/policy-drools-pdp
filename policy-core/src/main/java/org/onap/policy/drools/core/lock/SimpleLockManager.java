...
public class SimpleLockManager {
    ...
    /**
     * Attempts to lock a resource.  This method ignores the callback and always returns
     * a future with isDone()=true.  In addition, it does not throw IllegalStateException.
     * 
     * @param resourceId
     * @param owner
