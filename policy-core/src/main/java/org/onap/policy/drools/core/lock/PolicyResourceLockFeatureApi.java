...
public interface PolicyResourceLockFeatureApi extends OrderedService {
     ...
     * @throws RuntimeException if the feature has not been initialized yet
     */
    boolean enabled();
     ...
     * @return a new lock
     */
    Lock lock(String resourceId, Object ownerInfo, int holdSec, LockCallback callback, boolean waitForLock);
}
