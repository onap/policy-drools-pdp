...
public class MdcTransactionConstants {
     ...
     */
    public static final String RC_ACTIVE = "100";
    public static final String RC_REJECTED = "200";
    public static final String RC_OPERATION = "300";
    public static final String RC_OPERATION_SUCCESS = "301";
    public static final String RC_OPERATION_FAILURE = "302";
    public static final String RC_FINAL_FAILURE = "400";
    public static final String RC_FINAL_SUCCESS = "401";
    public static final String RC_FINAL_OPENLOOP = "402";
    public static final String RC_UNKNOWN_TYPE = "900";
