...
/**
 * Execution Record.  It has a generic format used for tracking of
 * policy executions. The fields in this class has been modelled
 * after the spec defined in the ONAP logging requirements.
 */
