...
public class PropertyUtil {
    ...
    public static Properties getInterpolatedProperties(Properties properties, CryptoCoder cryptoCoder) {
        ...
        interpolator.setEnableSubstitutionInVariables(false);
        interpolator.registerLookup(ENV_WITH_DEFAULT_PROPERTY_PREFIX, new EnvironmentVariableWithDefaultLookup());
