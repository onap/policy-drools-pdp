...
public class ProcessingStateTest {
    ...
    private static final String PREV_HOST = "prevHost";

    // this follows PREV_HOST, alphabetically
    private static final String MY_HOST = PREV_HOST + "X";

    // these follow MY_HOST, alphabetically
    private static final String HOST1 = MY_HOST + "1";
    private static final String HOST2 = MY_HOST + "2";
    private static final String HOST3 = MY_HOST + "3";
    private static final String HOST4 = MY_HOST + "4";

    private static final String LEADER = HOST1;

    private static final String[] HOST_ARR3 = {HOST1, MY_HOST, HOST2};

    private static final BucketAssignments EMPTY_ASGN = new BucketAssignments();
    private static final BucketAssignments ASGN3 = new BucketAssignments(HOST_ARR3);
    ...
    public void testProcessLeader_NullAssignment() {
        ...
        verify(factory, never()).goActive(any(), any(), any());
    ...
    public void testProcessLeader_MyHostAssigned() {
        ...
        when(factory.goActive(state, PREV_HOST, asgn)).thenReturn(next);
    ...
    public void testBecomeLeader() {
        State next = mock(State.class);
        when(factory.goActive(any(), any(), any())).thenReturn(next);

        assertEquals(next, state.becomeLeader(sortHosts(MY_HOST, HOST2)));

        Leader msg = captureAdminMessage(Leader.class);

        verify(factory).goActive(state, MY_HOST, msg.getAssignments());
    }
     ...
     */
    private SortedSet<String> sortHosts(String... hosts) {
     ...
     */
    private List<String> captureHostList() {
     ...
     */
    private String[] captureHostArray() {
     ...
     */
    private BucketAssignments captureAssignments() {
        Leader msg = captureAdminMessage(Leader.class);
     ...
     */
    private <T extends Message> T captureAdminMessage(Class<T> clazz) {
