 ...
 * The properties for the topic are copied from this feature's properties to the
 * controller's properties, so that the controller will launch the topic's
 * source and sink when it starts.
 */
...
public class PoolingFeature implements PolicyControllerFeatureAPI, PolicySessionFeatureAPI {
	...
	/**
	 * Copies properties from the feature's properties to the controller's
	 * properties so that the internal DMaaP topic source & sink will be created
