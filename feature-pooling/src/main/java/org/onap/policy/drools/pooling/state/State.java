...
public abstract class State {
     ...
     * 
     * @param leader the current leader, or {@code null} if the leader is
     *        still unknown
     * @param assignments known bucket assignments, or {@code null} if they
     *        are still unknown
     * @return the new state
     */
    public State goQuery(String leader, BucketAssignments assignments) {
        return factory.goQuery(this, leader, assignments);
    }
     ...
     * @return the new state
     */
    public State goActive(String leader, BucketAssignments assignments) {
        return factory.goActive(this, leader, assignments);
    }
    ...
    protected static class StateFactory {
         ...
         * @return the new state
         */
        public State goQuery(State oldState, String leader, BucketAssignments assignments) {
            return new QueryState(oldState, leader, assignments);
        }
         ...
         * @return the new state
         */
        public State goActive(State oldState, String leader, BucketAssignments assignments) {
            return new ActiveState(oldState, leader, assignments);
        }
