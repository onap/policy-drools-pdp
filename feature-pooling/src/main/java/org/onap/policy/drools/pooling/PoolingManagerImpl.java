...
public class PoolingManagerImpl implements PoolingManager, TopicListener {
    ...
    public PoolingManagerImpl(PolicyController controller, TypedProperties props) {
        ...
        try {
            ...
            this.topic = props.getStrProperty(PoolingProperties.POOLING_TOPIC);
            this.eventq = new EventQueue(props.getOptIntProperty(PoolingProperties.OFFLINE_LIMIT, 1000),
                            props.getOptIntProperty(PoolingProperties.OFFLINE_AGE_MS, 60000));
            this.dmaapMgr = new DmaapManager(topic, props);
    ...
    private class EventQueue {
         ...
         * older than this are discarded rather than being handed off
         * downstream.
         */
