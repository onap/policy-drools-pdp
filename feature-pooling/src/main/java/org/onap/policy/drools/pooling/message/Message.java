...
@JsonSubTypes({
	@Type(value = Forward.class, name = "forward"),
	...
	@Type(value = Offline.class, name = "offline"),
...
public class Message {
	...
	/**
	 * Consumers can read from this channel if they don't wish to receive
	 * anything.
	 */
	...
	/**
	 * Channel on which the message is routed, which is the target host
	 * or {@link #ADMIN}.
	 */
