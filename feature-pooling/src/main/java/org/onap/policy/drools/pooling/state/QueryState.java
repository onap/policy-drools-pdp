 ...
 * identify themselves. Eventually, a leader should come forth.
 */
public class QueryState extends ProcessingState {
     ...
     */
    private boolean awaitingLeader = false;
    ...
    /**
     * Sets the assignments, if they are not currently set.
     * 
