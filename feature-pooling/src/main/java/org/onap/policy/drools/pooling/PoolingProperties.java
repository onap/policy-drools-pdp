...
public class PoolingProperties extends SpecPropertyConfiguration {
    ...
    public long getLeaderMs() {
        return additional.getLeaderMs();
    }
    ...
    private static class AdditionalProperties extends SpecPropertyConfiguration {
        ...
        /**
         * Time, in milliseconds, to wait for the lead host to take charge
         * during the query state.
         */
        @Property(name = LEADER_MS, defaultValue = "70000")
        private long leaderMs;
