...
class HealthCheckMonitor implements HealthCheck {
    ...
    /**
     * Used to access various objects in a way that can be overridden by junit tests.
     */
    ...
    public Reports healthCheck() {
        ...
        boolean thisEngineIsAlive = factory.getEngineManager().isAlive();
    ...
    public boolean start() {
        ...
        try {
            this.healthCheckProperties = factory.getProperties(HealthCheckFeature.CONFIGURATION_PROPERTIES_NAME);
            this.servers = factory.getServerFactory().build(healthCheckProperties);
            this.clients = factory.getClientFactory().build(healthCheckProperties);
    ...
    /**
     * Factory to access various objects in a way that can be overridden by junit tests.
     */
    public static class Factory {

        public PolicyEngine getEngineManager() {
