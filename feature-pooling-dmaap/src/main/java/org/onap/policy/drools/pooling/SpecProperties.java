...
public class SpecProperties extends Properties {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((specPrefix == null) ? 0 : specPrefix.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SpecProperties other = (SpecProperties) obj;
        if (prefix == null) {
            ...
            return false;
        if (specPrefix == null) {
            if (other.specPrefix != null)
                return false;
        } else if (!specPrefix.equals(other.specPrefix))
            return false;
        return true;
    }
}
