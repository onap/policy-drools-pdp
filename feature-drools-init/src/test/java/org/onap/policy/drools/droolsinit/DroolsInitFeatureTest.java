...
public class DroolsInitFeatureTest {
    private static final String POLICY_ENGINE_CONSTANTS_MANAGER_FIELD = "manager";
    private static PolicyEngine savePolicyEngine;
    ...
    public static void setUpBeforeClass() {
        savePolicyEngine = Whitebox.getInternalState(
            PolicyEngineConstants.class, POLICY_ENGINE_CONSTANTS_MANAGER_FIELD);
    ...
    public static void cleanup() {
        Whitebox.setInternalState(PolicyEngineConstants.class,
            POLICY_ENGINE_CONSTANTS_MANAGER_FIELD, savePolicyEngine);
    }
    ...
    public void initTest() {
        ...
        PolicyEngine mgr = mock(PolicyEngine.class);
        when(mgr.getExecutorService()).thenReturn(executorService);
        Whitebox.setInternalState(PolicyEngineConstants.class, POLICY_ENGINE_CONSTANTS_MANAGER_FIELD, mgr);
