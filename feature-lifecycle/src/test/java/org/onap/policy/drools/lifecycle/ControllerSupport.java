...
public class ControllerSupport {
    ...
    public PolicyController createController() throws IOException {
        ...
        return PolicyControllerFactoryInstance.getInstance().build(name, controllerProps);
    }
    ...
    public void destroyController() {
        PolicyControllerFactoryInstance.getInstance().destroy(name);
    }
    ...
    public PolicyController getController() {
        return PolicyControllerFactoryInstance.getInstance().get(name);
    }
