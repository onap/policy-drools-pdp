...
public class DistributedLockingFeatureOld implements PolicyEngineFeatureApi, PolicyResourceLockFeatureApi {

    /**
     * Logger instance.
     */
    private static final Logger logger = LoggerFactory.getLogger(DistributedLockingFeatureOld.class);
    ...
    public boolean afterStart(PolicyEngine engine) {
        ...
        try {
            this.lockProps = new DistributedLockingProperties(SystemPersistenceConstants.getManager()
                            .getProperties(DistributedLockingFeatureOld.CONFIGURATION_PROPERTIES_NAME));
