...
public class DistributedLockingProperties extends PropertyConfiguration{
	...
	public static final String LOCKING_PROPERTY = PREFIX +"enabled";
     ...
     */
    @Property(name = AGING_PROPERTY, defaultValue = "30000")
     ...
     */
    @Property(name = LOCKING_PROPERTY)
    private boolean lockingProperty;
	...
	public boolean getLockingProperty() {
		return lockingProperty;
	}
