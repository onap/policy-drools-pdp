...
public class DistributedLockingFeature
    ...
    public DistributedLock lock(String resourceId, Object ownerInfo, int holdSec, LockCallback callback,
        ...
        DistributedLock lock = new DistributedLock(Lock.State.WAITING, resourceId, ownerInfo, holdSec, callback);
    ...
    protected class DistributedLock extends LockImpl {
         ...
         */
        public DistributedLock(State state, String resourceId, Object ownerInfo, int holdSec, LockCallback callback) {
