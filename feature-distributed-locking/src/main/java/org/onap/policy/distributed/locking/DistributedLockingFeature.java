 ...
 * expired.</li>
 * <li>When a lock is deserialized, it will not initially appear is this feature's map; it
...
public class DistributedLockingFeature
    ...
    private static DistributedLockingFeature latestInstance = null;
    ...
    public int getSequenceNumber() {
        // low priority, but still higher than the simple implementation
        return 900;
    }
    ...
    /**
     * Closes the data source. Does <i>not</i> invoke any
     * lock call-backs.
     */
    @Override
    ...
    public static class DistributedLock extends LockImpl {
         ...
         */
        private transient DistributedLockingFeature feature;
         ...
         */
        public DistributedLock(LockState state, String resourceId, Object ownerInfo, int holdSec, LockCallback callback,
                        DistributedLockingFeature feature) {
            /*
    ...
    protected DistributedLock makeLock(LockState state, String resourceId, Object ownerInfo, int holdSec,
        ...
        return new DistributedLock(state, resourceId, ownerInfo, holdSec, callback, this);
    }
}
